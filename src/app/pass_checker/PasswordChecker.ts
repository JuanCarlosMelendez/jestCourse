...
export enum PasswordErrors {
    SHORT         = 'Password muy corta!',
    NO_UPPER_CASE = 'Caracter en mayuscula es requerido!',
    NO_LOWER_CASE = 'Caracter en minuscula es requerido!',
    NO_NUMBER     = 'Al menos un numero es requerido!'
}
